...
#         last_one = 100
#         for i in range(n):
#             if isinstance(individual[i], list):  # 如果是和弦
#                 for note in individual[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals.append(abs(note - last_one))
#                         last_one = note
#             else:  # 如果是单音符
#                 if individual[i] not in [0, 28, last_one]:
#                     intervals.append(abs(individual[i] - last_one))
...
#                     if note != 28:
#                         last_one = note
#                         if note in unpreferred_pitches:
#                             score += 1
#                     elif note == 28 and last_one in unpreferred_pitches:
#                         score += 1
#             else:  # 如果是单音符
#                 if individual[i] != 28:
#                     last_one = individual[i]
...
#         for i in range(n):
#             if isinstance(individual[i], list):  # 如果是和弦
#                 durations.append(1)  # 和弦的持续时间视为 1
#             else:  # 如果是单音符
#                 if individual[i] != 28:
#                     durations.append(1)
#                 elif durations:
...
#                 for note in individual[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals.append(note - last_one)
#                         last_one = note
#             else:  # 如果是单音符
#                 if individual[i] not in [0, 28, last_one]:
#                     intervals.append(individual[i] - last_one)
...
#             if isinstance(individual[i], list):  # 如果是和弦
#                 for note in individual[i]:
#                     if note >= 1 and note <= 27:
#                         total += 1
#                         for j in range(max(1, note - 12), min(15, note) + 1):
#                             octaves[j - 1] += 1
#             else:  # 如果是单音符
#                 if individual[i] >= 1 and individual[i] <= 27:
#                     total += 1
...
#         last_one = 100
#         for i in range(self.individualLength // 4):
#             if isinstance(bar1[i], list):  # 如果是和弦
#                 for note in bar1[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals1.append(abs(note - last_one))
#                         last_one = note
#             else:  # 如果是单音符
#                 if bar1[i] not in [0, 28, last_one]:
#                     intervals1.append(abs(bar1[i] - last_one))
...
#         last_one = 100
#         for i in range(self.individualLength // 4):
#             if isinstance(bar2[i], list):  # 如果是和弦
#                 for note in bar2[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals2.append(abs(note - last_one))
#                         last_one = note
#             else:  # 如果是单音符
#                 if bar2[i] not in [0, 28, last_one]:
#                     intervals2.append(abs(bar2[i] - last_one))
...
#         last_one = 100
#         for i in range(self.individualLength // 4):
#             if isinstance(bar3[i], list):  # 如果是和弦
#                 for note in bar3[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals3.append(abs(note - last_one))
#                         last_one = note
#             else:  # 如果是单音符
#                 if bar3[i] not in [0, 28, last_one]:
#                     intervals3.append(abs(bar3[i] - last_one))
...
#         last_one = 100
#         for i in range(self.individualLength // 4):
#             if isinstance(bar4[i], list):  # 如果是和弦
#                 for note in bar4[i]:
#                     if note not in [0, 28, last_one]:
#                         intervals4.append(abs(note - last_one))
#                         last_one = note
#             else:  # 如果是单音符
#                 if bar4[i] not in [0, 28, last_one]:
#                     intervals4.append(abs(bar4[i] - last_one))

...
``` bash
main.py populationSize individualLength Flag_M Flag_T Flag_I Flag_R Flag_C mutationRatio crossoverRatio maxIter fitness_Iter fitness_Final fitnessFunction
```
...
### Natural Selection and Fitness Function
...
### From Digital Encoding to Musical Notation
